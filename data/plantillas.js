...
const revision_plantilla = ({ texto_1 }) => {
    ...
    <instruction>
    Revisa cada RespuestaEstudiante respecto a la función descrita dentro del mismo de cada JSON  en target_content_requested_text . Tienes que evaluar distintos parámetros con nota de 1 a 10 y además tendrás que dar una pequeña retroalimentación de lo respondido.
    </instruction>
    <example_responses>
    [
        {
